...
//    }
    ...
    public static function queryRetrieveDevicesByUserId() {
        return "SELECT * FROM crypto_device WHERE fk_user_id = :user_id;";
    }

    public static function queryInsertNewDevice() {
